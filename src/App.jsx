...
import NamePage from "./pages/User/NamePage";
import AcceptPage from "./pages/User/AcceptPage";
import AllSetPage from "./pages/User/AllSetPage";
      ...
      <Box sx={{ minHeight: "100vh", bgcolor: "#fafafa", display: "flex", flexDirection: "column", pb: page !== "signup" ? "80px" : 0 }}>
        ...
        {page !== "signup" && (
          <Box sx={{ position: "fixed", bottom: 0, left: 0, width: "100%", bgcolor: "#fafafa", p: 2, display: "flex", justifyContent: page === "allset" ? "flex-end" : "space-between", alignItems: "center", boxShadow: "0 -2px 8px rgba(0,0,0,0.1)", zIndex: 1000 }}>
            ...
            <Button variant="contained" onClick={page === "allset" ? () => alert("Continue clicked") : handleNext} disabled={page !== "allset" && isNextDisabled} sx={{ borderRadius: "50px", bgcolor: page !== "allset" && isNextDisabled ? "grey.400" : "primary.main", "&:hover": { bgcolor: page !== "allset" && isNextDisabled ? "grey.400" : "#D8A71C" }, px: 4, py: 1.5 }}>
